...
function viewPost() {
    ...
    req.addEventListener('load', function(){
        ...
        if (received_data.viewDetailPost == false) {
            ...
            // Get reporter
            let reporter = sessionStorage.getItem("reportingUser");
            document.getElementById("reporter").innerHTML = `<u>Reporter:</u> <i style="color:purple;">@${reporter}</i>`;
            let reasonText = sessionStorage.getItem("reasonText");
            document.getElementById("reason-text").innerHTML = `<u>Reason:</u> <i style="color:purple;">${reasonText}</i>`;
...
function deleteViolatedPost() {
    ...
    req.addEventListener('load', function(){
        ...
        else if (received_data.deleteViolatedPost == false) {
            alert("Cannot do action because this post was deleted before!");
            history.back();
        }
    });
}
...
function ignoreDeletingPost() {
    ...
    req.addEventListener('load', function(){
        ...
        else if (received_data.ignoreDeletingPost == false) {
            alert("Cannot do action because this post was deleted before!");
            history.back();
        }
    });

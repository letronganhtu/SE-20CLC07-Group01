...
function signUpFormat(form_id) {
    ...
    if (uname === "" || psw === "" || confirm_psw === "" || firstname === ""
    || surname === "" || email === "" || phone === "" || dateOfBirth === "" || gender === "") {
        return false;
    }
    if (checkUsername === false || checkLowerCase === false || checkUpperCase === false || checkNumber === false || checkLength === false || checkSpecialCharacter === false || checkMatchedPassword === false || checkFirstname === false || checkSurname === false || checkGender === false || checkEmail === false || checkPhone === false || checkDOB === false) {
...
function SendToAndGetDataFromServer() {
    if (document.forms["sign-up-form"]["gender"].value != "") {
        checkGender = true;
    }
    if (document.forms["sign-up-form"]["dateOfBirth"].value != "") {
        checkDOB = true;
    }

function viewProfile() {
    let username = sessionStorage.getItem('reportedUser');
...
function getTheirRecipes() {
    username = sessionStorage.getItem('reportedUser');
        ...
        if (received_data.getMyRecipes == true) {
            ...
            if (posts.length === 0) {
                ...
                for(let i = 0; i < posts.length; i++) {
                    ...
                    HTMLpost += `<div id="recipe-${String(i + 1)}" class="recipe">
...
function suspendViolatedAccount() {
    let reportID = sessionStorage.getItem('reportID');
    let reportedUser = sessionStorage.getItem('reportedUser');
...
function ignoreSuspendingAccount() {
    let reportID = sessionStorage.getItem('reportID');
    let reportedUser = sessionStorage.getItem('reportedUser');
